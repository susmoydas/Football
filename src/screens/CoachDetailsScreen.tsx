  ...
  if (loading) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: C.bg }} edges={['top', 'bottom']}>
        <Header title="Coach" showBack onBackPress={() => navigation?.goBack()} />
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 40 }}>
          <SoftSkeleton>
            <Card size="sm" variant="elevated" className="rounded-xl mx-4 mb-4 items-center py-6">
              ...
              <SkeletonBlock style={{ width: 100, height: 14, marginTop: 8 }} />
            </Card>
            ...
            <Box className="mx-4 mb-4">
              ...
              <Card size="sm" variant="elevated" className="rounded-xl px-4 py-5 items-center">
                <SkeletonBlock style={{ width: 80, height: 10, marginBottom: 12 }} />
                <SkeletonBlock style={{ width: 120, height: 48 }} />
                <HStack className="gap-4 mt-3">
                  <SkeletonBlock style={{ width: 40, height: 30 }} />
                  <SkeletonBlock style={{ width: 40, height: 30 }} />
                  <SkeletonBlock style={{ width: 40, height: 30 }} />
                </HStack>
              </Card>
            ...
            <Box className="mx-4 mb-4">
              <SkeletonBlock style={{ width: 120, height: 20, marginBottom: 12 }} />
              {[1, 2, 3].map(i => (
                <HStack key={i} className="gap-3 mb-3">
