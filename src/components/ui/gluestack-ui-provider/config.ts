...
export const config = {
  ...
  dark: vars({
    ...
    /* Success */
    "--color-success-0": "#0A2E1E",
    "--color-success-50": "#0C452A",
    "--color-success-100": "#0E5C36",
    "--color-success-200": "#0A7A4F",
    "--color-success-300": "#068C59",
    "--color-success-400": "#0D9F68",
    "--color-success-500": "#01935C",
    "--color-success-600": "#049C63",
    "--color-success-700": "#34B87A",
    "--color-success-800": "#68D49E",
    "--color-success-900": "#A2EDC4",
    "--color-success-950": "#D4F9E5",
    ...
    "--color-typography-700": "#737373",
    "--color-typography-800": "#525252",
    "--color-typography-900": "#404040",
    "--color-typography-950": "#171717",
    ...
    "--color-background-50": "#1D1D1D",
    "--color-background-100": "#353535",
    "--color-background-200": "#3B3B3B",
    "--color-background-300": "#555555",
    "--color-background-400": "#6B6B6B",
    "--color-background-500": "#8A8A8A",
    "--color-background-600": "#A3A3A3",
    "--color-background-700": "#C7C7C7",
    "--color-background-800": "#E0E0E0",
    "--color-background-900": "#ECECEC",
    "--color-background-950": "#F8F8F8",

    /* Background Special */
    "--color-background-error": "#422B2B",
    "--color-background-warning": "#412F23",
    "--color-background-success": "#1A2E24",
    "--color-background-muted": "#252525",
    "--color-background-info": "#1A282E",

    /* Border */
    "--color-border-0": "#000000",
    "--color-border-50": "#1D1D1D",
    "--color-border-100": "#353535",
    "--color-border-200": "#3B3B3B",
    "--color-border-300": "#555555",
    "--color-border-400": "#6B6B6B",
    "--color-border-500": "#8A8A8A",
    "--color-border-600": "#A3A3A3",
    "--color-border-700": "#C7C7C7",
    "--color-border-800": "#E0E0E0",
    "--color-border-900": "#ECECEC",
    "--color-border-950": "#F8F8F8",
  }),
};
